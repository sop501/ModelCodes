...
public class ModelClass2 {
	public static void main(String [] args) throws Exception{
		...
		String te = "file:/C:/Users/Popoola/git/ModelClass/org.eclipse.epsilon.modelStynthesis/src/org/eclipse/epsilon/modelStynthesis/Ecore.ecore";
		String te2 = "file:/C:/Users/Popoola/git/ModelClass/org.eclipse.epsilon.modelStynthesis/src/org/eclipse/epsilon/modelStynthesis/std.ecore";
		
		File file= new File("C:/Users/Popoola/git/ModelClass/org.eclipse.epsilon.modelStynthesis/src/org/eclipse/epsilon/modelStynthesis/operations.eol");
		...
		List<EPackage> metaPackag= new ArrayList<EPackage>();
		//EmfMetaModel meta = new EmfMetaModel();
		//meta.load();
		
		//create a new model
		EmfModel model= createEmfModel("Model", te,te, true, false);
		EmfModel model2= createEmfModel("Model2", te2,te, false, true);
			...
			for(EClassifier clas:po.getEClassifiers() ){
				if(clas instanceof EClass){
					...
					if(!(eclass.isAbstract())){
						...
						clasNew.setName(eclass.getName()+"N");
						...
						for (Operation operation: operationNames){
							if(operation.getContextType(context).getName().equals(eclass.getName())){					
								...
								for (int i = 0; i<instances; i++) {
									...
									//EClass clas2= (EClass) EcoreUtil.copy(eclass);
								...
								//	model.
									//model2.
									//Object modelObject = model2.createInstance(eclass.getName());
									
									model2.store("C:/Users/Popoola/git/ModelClass/org.eclipse.epsilon.modelStynthesis/src/org/eclipse/epsilon/modelStynthesis/std.ecore");
		...
		model2.getResource().getContents().add(pack);
		model2.store("C:/Users/Popoola/git/ModelClass/org.eclipse.epsilon.modelStynthesis/src/org/eclipse/epsilon/modelStynthesis/std.ecore");
