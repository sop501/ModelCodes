...
public class EndlabelsPackageImpl extends EPackageImpl implements EndlabelsPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link EndlabelsPackage#eINSTANCE} when that field is accessed.
	...
	public static EndlabelsPackage init() {
		...
		EndlabelsPackageImpl theEndlabelsPackage = (EndlabelsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EndlabelsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EndlabelsPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(EndlabelsPackage.eNS_URI, theEndlabelsPackage);
